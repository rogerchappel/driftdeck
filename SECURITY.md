...
Replace this section with the supported versions for `driftdeck`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `driftdeck` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in driftdeck.
